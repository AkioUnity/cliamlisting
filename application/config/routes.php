...
$route['(:any)/categories'] 	= "(:any)/show/categories"; // added on version 1.6
$route['(:any)/pricing'] 		= "(:any)/show/pricing"; // added on version 1.6
$route['(:any)/featured-businesses'] 		= "(:any)/show/featured_businesses"; // added on version 1.6
