...
class User_core extends CI_Controller {
	...
	public function create_ad()
	{
		...
		$this->form_validation->set_rules('address_'.default_lang(), 				lang_key('address'), 				'required');		
		$this->form_validation->set_rules('description_'.default_lang(), 		lang_key('description'), 		'required');
		
		$this->form_validation->set_rules('website', 		lang_key('website'), 		'xss_clean');
		$this->form_validation->set_rules('founded', 		lang_key('founded'), 		'xss_clean');
		$this->form_validation->set_rules('price_range', 	lang_key('price_range'), 	'xss_clean');
	...
	public function updatepost()
	{
		...
		$this->form_validation->set_rules('facebook_profile', 			lang_key('facebook_profile'), 		'xss_clean');
		$this->form_validation->set_rules('twitter_profile', 			lang_key('twitter_profile'), 		'xss_clean');
		$this->form_validation->set_rules('linkedin_profile', 			lang_key('linkedin_profile'), 		'xss_clean');
		$this->form_validation->set_rules('pinterest_profile', 			lang_key('pinterest_profile'), 		'xss_clean');
		$this->form_validation->set_rules('googleplus_profile', 		lang_key('googleplus_profile'), 	'xss_clean');
		$this->form_validation->set_rules('assigned_to', 				lang_key('assigned_to'), 			'xss_clean');
