        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/business/savebusinesssettings/');?>" method="post">
                    ...
                    <div class="form-group" >
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('gallery_upload_limit'); ?></label>

                        <div class="ol-sm-9 col-md-3 controls">
                            <input type="text" name="gallery_upload_limit" value="<?php echo(isset($settings->gallery_upload_limit))?$settings->gallery_upload_limit:'';?>" placeholder="<?php echo lang_key('type_something');?>" class="form-control" >
                            <input type="hidden" name="gallery_upload_limit_rules" value="required">
                            <span class="help-inline">&nbsp;</span>
                            <?php echo form_error('gallery_upload_limit'); ?>
                        </div>
                    </div>
                    <!-- end -->
