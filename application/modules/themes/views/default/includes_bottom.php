    ...
    <div id="adblock-msg-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="<?php echo theme_url();?>/assets/img/adblock.png" class="img-fluid" />
                    <br/>
                    <br/>
...
<!-- added on version 1.8 -->
<?php
if(get_settings('business_settings','enable_cookie_policy_popup','No')=='Yes'){
    require_once 'eu_cookie_popup.php';     
}
?>   
<?php if(get_settings('business_settings','enable_adblocker_alert','No')=='Yes'){?>
