        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="shopping-content">
                    <div class="shopping-checkout">
                         ...
                         <div class="form-group">
                            ...
                            <div class="checkbox col-md-8 col-sm-8 col-xs-8">
                                <label>
                                    ...
                                    <?php echo lang_key('hide_my_phone'); ?>
                                </label>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="checkbox col-md-8 col-sm-8 col-xs-8">
                                <label>
                                    ...
                                    <?php echo lang_key('hide_my_email'); ?>
                                </label>
                            </div>
                        </div>
                                     ...
                                     <div id="<?php echo $lang;?>" class="tab-pane fade in <?php echo (default_lang()==$lang)?'active':'';?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" name="address_<?php echo $lang;?>" placeholder="<?php echo lang_key('address');?>" value="<?php echo $v;?>" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox col-md-8 col-sm-8 col-xs-8">
                                    <label>
                                        ...
                                        <input <?php echo $chk;?> type="checkbox" class="" value="1" name="disable_google_street_view">
                                        <?php echo lang_key('disable_google_street_view'); ?>
                                    </label>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo lang_key('camera_spin');?></label>
                                <div class="col-md-8">
                                    ...
                                    <select name="camera_spin" class="form-control">
                                        <?php 
                                        $options = $this->config->item('camera_spin_options');
                                        foreach ($options as $spin) {
                                            $chk = ($spin==$v)?'selected="selected"':'';
                                        ?>
                                        <option value="<?php echo $spin;?>" <?php echo $chk;?> ><?php echo $spin;?> <?php echo lang_key('degree');?></option>
                                        <?php 
                                        }
                                        ?>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox col-xs-9">
                                <label>
                                    <?php $chk = (isset($_POST['always_open']) && $_POST['always_open']=='1')?'checked="checked"':'';?>
                                    <?php $chk = ($chk =='' && get_post_meta($post->id,'always_open','')=='1')?'checked="checked"':$chk;?>
                                    <input <?php echo $chk;?> type="checkbox" class="open_24_by_7" value="1" name="always_open">
                                    <?php echo lang_key('open_24_by_7'); ?>
                                </label>
                            </div>
                        </div>
                        ...
                        $default_opening_val = ($this->config->item('opening_hour_format')=='24')?'09:00':'09:00 '.lang_key('AM');
                        $default_closing_val = ($this->config->item('opening_hour_format')=='24')?'17:00':'05:00 '.lang_key('PM');
                    ...
                    //end
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?php echo lang_key('instagram');?></label>
                            <div class="col-md-8">
                                <input type="text" name="instagram_profile" value="<?php echo get_post_meta($post->id,'instagram_profile','');?>" class="form-control">
                            </div>
                        </div>
                        <!-- end -->
                    </div>
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs" id="myTab2">
                    <?php $flag=1; foreach ($langs as $lang=>$long_name){ 
                        ?>
                    <li class="<?php echo (default_lang()==$lang)?'active':'';?>"><a data-toggle="tab" href="#<?php echo $lang;?>-<?php echo $flag;?>"><i class="fa fa-home"></i> <?php echo $lang;?></a></li>
                    <?php $flag++; }?>
                </ul>
                <div class="tab-content" id="myTabContent2">
                     <?php $flag=1; foreach ($langs as $lang=>$long_name){ 
                     ?>
                     <div id="<?php echo $lang;?>-<?php echo $flag;?>" class="tab-pane fade in <?php echo (default_lang()==$lang)?'active':'';?>">
...
jQuery(document).ready(function(){
    ...
    obj.on('drop', function (e)
    {
        // updated on version 1.7
         ...
         {
            var msg = "<?php echo lang_key('you_can_upload_max').' '.get_settings('business_settings','gallery_upload_limit',50).' '.lang_key('gallery_photos');?>";
            alert(msg);
         }
         else
...
jQuery(document).ready(function(){
    ...
    // updated on version 1.5
    var time_format = '<?php echo $this->config->item("opening_hour_format");?>';
    var amName = '<?php echo lang_key("AM");?>';
    var pmName = '<?php echo lang_key("PM");?>';
    for(var i=1; i<=7; i++)
    {
        ...
        {
            $(startTimeTextBox).timepicker({timeFormat: 'hh:mm TT',amNames:[amName,'A'],pmNames:[pmName,'P']});
