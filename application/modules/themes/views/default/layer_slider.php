...
<!--        <img alt="slide-image" data-src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/food.png"-->
<!--             src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/food.png"-->
<!--             data-ls="offsetxin:0;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;"-->
<!--             style="top: 124px; left: 845.5px;white-space: nowrap;" class="ls-l ls-preloaded">-->
...
<!--           class="ls-l">LOOKING TO LIST YOUR RESTAURANT</p>-->
...
<!--           class="ls-l">Lorem Ipsum dolor sit</p>-->
...
<!--            class="ls-l">PIZZA - SUBS - BURGERS - FRIES</h1>-->
<!--        <img alt="slide-image" data-src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/catering.png"-->
<!--             src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/catering.png" data-ls="delayin:1000;"-->
<!--             style="top: 96px; left: 795.5px;white-space: nowrap;" class="ls-l ls-preloaded">-->
...
<!--             src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/left.png" alt="slide-image">-->
<!--        <img class="ls-l ls-linkto-2" style="top:460px;left:650px;white-space: nowrap;"-->
<!--             data-ls="offsetxin:50;delayin:1000;offsetxout:50;"-->
<!--             src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/right.png" alt="slide-image">-->
<!--    </div>-->
<!--    <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">-->
<!--        <img src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/fw-1.jpg" class="ls-bg" alt="Slide background"/>-->
<!--        <img alt="slide-image" data-src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/party_copy.png"-->
<!--             src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/party_copy.png"-->
<!--             data-ls="offsetxin:0;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;"-->
<!--             style="top: 124px; left: 700.5px;white-space: nowrap;" class="ls-l ls-preloaded">-->
<!--        <p data-ls="durationin:2000;delayin:1500;easingin:easeOutElastic;rotatexin:-90;transformoriginin:50% top 0;durationout:1000;"-->
<!--           style="top: 220px; left: 112.5px;font-weight: 300;height:40px;padding-right:10px;padding-left:10px;font-size:30px;line-height:37px;color:#ffffff;background:#f04705;border-radius:3px;white-space: nowrap;"-->
<!--           class="ls-l">YOUR FAVOURITE NIGHTLIFE DESTINATION</p>-->
<!--        <p data-ls="offsetxin:0;durationin:2000;delayin:2000;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% top 0;offsetxout:-400;"-->
...
<!--    <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">-->
<!--        <img src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/fw-1.jpg" class="ls-bg" alt="Slide background"/>-->
<!--        <img class="ls-l" style="top:129px;left:487px;white-space: nowrap;"-->
<!--             data-ls="offsetxin:400;durationin:2000;offsetxout:400;"-->
<!--             src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/d1.png" alt="slide-image">-->
<!--        <img class="ls-l" style="top:104px;left:70px;white-space: nowrap;"-->
<!--             data-ls="offsetxin:-200;durationin:2000;offsetxout:-200;"-->
<!--             src="--><?php //echo theme_url(); ?><!--/assets/layerslider/img/d2.png" alt="slide-image">-->
<!--        <p class="ls-l"-->
<!--           style="top:320px;left:830px;font-weight: 300;height:40px;padding-right:10px;padding-left:10px;font-size:30px;line-height:37px;color:#ffffff;background:#544f8c;border-radius:3px;white-space: nowrap;"-->
...
<!--        </p>-->
<!--        <p class="ls-l"-->
<!--           style="top:360px;left:836px;font-family:'Indie Flower';font-size:31px;color:#544f8c;white-space: nowrap;"-->
