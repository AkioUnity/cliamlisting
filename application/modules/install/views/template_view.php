...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Justmy Installation</title>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand" href="<?php echo site_url('install');?>">Justmy Installation</a>
	...
	<div id="footer">
      <div class="container">
        <p class="muted credit">Developed By <a href="http://www.justmy.com">JustMy</a></p>
      </div>
    </div>
